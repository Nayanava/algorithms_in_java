...
public class MinimumFlipsToMakeAllZeroes {
    ...
    public static void main(String[] args) {
        int mat[][] = {{0, 0}, {0, 1}};
        MinimumFlipsToMakeAllZeroes minimumFlipsToMakeAllZeroes = new MinimumFlipsToMakeAllZeroes();
        System.out.print(minimumFlipsToMakeAllZeroes.minFlips(mat));
    }
}
